 ...
 * @author María Galbis
 */
public class DirectorJsonForm implements JsonSerializer<Director> {
    private PeliculaDao peliculaDao = new PeliculaDao();
    
    public static String toJson(Director p) {
        GsonBuilder gsonBuilder = new GsonBuilder();
        Gson gson = gsonBuilder.registerTypeAdapter(Director.class, new DirectorJsonForm()).create();
